...
const translations = {
  de: {
    ...
    authenticItalianExperience: "Eine authentische italienische kulinarische Erfahrung",
    authenticItalianCuisine: "Authentische italienische Küche",
    returnToHome: "Zurück zur Startseite",
    returnShort: "Zurück",
    menuCover: "Menü",
    traditionalItalianCuisine: "Traditionelle italienische Küche",
    ...
    page: "Seite",
    of: "von",
    readyToDiscover: "Bereit, unsere authentischen italienischen Aromen zu entdecken?",
    discoverOurFlavors: "Entdecken Sie unsere italienischen Aromen",
  ...
  en: {
    ...
    authenticItalianExperience: "An authentic Italian culinary experience",
    authenticItalianCuisine: "Authentic Italian cuisine",
    returnToHome: "Return to home",
    returnShort: "Return",
    menuCover: "Menu",
    traditionalItalianCuisine: "Traditional Italian Cuisine",
    ...
    page: "Page",
    of: "of",
    readyToDiscover: "Ready to discover our authentic Italian flavors?",
    discoverOurFlavors: "Discover our Italian flavors",
